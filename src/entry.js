...
const UI_SCRIPTS='<script src="/loading-view.js"></script><script type="module" src="/schedule-view.js"></script><script type="module" src="/billing-view.js"></script><script type="module" src="/reports-view.js"></script>';
...
export default{
  async fetch(request,env,ctx){
    ...
    if(url.pathname==='/api/health'){
      return json({ok:true,app:env.APP_NAME||'Sozan Tutor OS',version:'5.0',mutation_dedupe:true,receipt_rebalance:true,schedule_views:true,reports:true,monthly_billing:true,loading_state:true});
    }
    ...
    if((url.pathname==='/'||url.pathname==='/index.html')&&request.method==='GET'){
      ...
      if(!html.includes('/billing-view.js')){
