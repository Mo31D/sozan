const CACHE='sozan-v5-monthly-billing';
const STATIC=['/','/index.html','/styles.css','/app.js','/schedule-view.js','/billing-view.js','/billing-dialog-sync.js','/reports-view.js','/loading-view.js','/manifest.webmanifest','/icon.svg'];
