const CACHE='sozan-v5-1-deep-audit';
const STATIC=['/','/index.html','/styles.css','/app.js','/audit-ui.js','/schedule-view.js','/billing-view.js','/billing-dialog-sync.js','/reports-view.js','/loading-view.js','/manifest.webmanifest','/icon.svg'];
